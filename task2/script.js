...
const chart = document.querySelector('.icon')

btn.addEventListener('click', () => {
    if (chart.innerHTML.includes('circle')) {
        chart.innerHTML = `
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="fill" viewBox="0 0 16 16">
    ...
    `;
        ...
        chart.innerHTML = `
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="circle" viewBox="0 0 16 16">
